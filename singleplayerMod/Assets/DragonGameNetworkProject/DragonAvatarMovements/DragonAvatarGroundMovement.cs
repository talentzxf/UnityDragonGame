...
namespace DragonGameNetworkProject.DragonAvatarMovements
{
    ...
    public class DragonAvatarGroundMovement : AbstractCharacterMovement
    {
        ...
        private int _isWalkingHash = UnityEngine.Animator.StringToHash("IsWalking");
        ...
        private void Update()
        {
            //if (HasStateAuthority)
            {
                ...
                {
                    mecanimAnimator.Animator.SetBool(_isWalkingHash, false);
                }
                else
                {
                    mecanimAnimator.Animator.SetBool(_isWalkingHash, true);
                }
