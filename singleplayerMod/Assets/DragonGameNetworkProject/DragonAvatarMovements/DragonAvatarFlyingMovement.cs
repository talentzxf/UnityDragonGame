...
namespace DragonGameNetworkProject.DragonAvatarMovements
{
    ...
    public class DragonAvatarFlyingMovement : AbstractCharacterMovement
    {
        ...
        private int isFlying = UnityEngine.Animator.StringToHash("IsFlying");
        private int isDashing = UnityEngine.Animator.StringToHash("IsDashing");
        private int flyingSpeed = UnityEngine.Animator.StringToHash("FlyingSpeed");
        private int dashProgress = UnityEngine.Animator.StringToHash("DashProgress");
