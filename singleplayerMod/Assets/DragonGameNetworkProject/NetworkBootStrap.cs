...
[AddComponentMenu("Network BootStrap")]
// [ScriptHelp(BackColor = ScriptHeaderBackColor.Steel)]
public class NetworkBootStrap : Behaviour
{
    /// <summary>
...
//     /// </summary>
//     [InlineHelp] [FormerlySerializedAs("Server")] [DrawIf(nameof(StartMode), (long) StartModes.Automatic, Hide = true)]
...
//
//     [NonSerialized] NetworkRunner _server;
//
//     /// <summary>
