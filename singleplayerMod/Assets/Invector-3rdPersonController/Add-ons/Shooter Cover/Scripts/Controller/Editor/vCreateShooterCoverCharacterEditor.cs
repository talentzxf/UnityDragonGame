...
namespace Invector.vShooter
{
    ...
    public class vCreateShooterCoverCharacterEditor : EditorWindow
    {
        GUISkin skin;
        ...
        /// </summary>    
        [MenuItem("Invector/Cover Add-On/Create Cover Controller", false, 2)]
        public static void CreateNewCharacter()
        {
            GetWindow<vCreateShooterCoverCharacterEditor>();
        }
        ...
        public virtual void OnGUI()
        {
            ...
            this.minSize = rect;
            this.titleContent = new GUIContent("Character", null, "Third Person Cover Controller Creator");
            GUILayout.BeginVertical("Cover Controller Creator Window", "window");
        ...
        /// <summary>
        /// Created the Third Person Cover Controller
        /// </summary>
